...
SVGRenderer.prototype = {
	 ...
	 *
	 * @param {Object} color The color or apkconfiguration object
	 */
	color: function (color, elem, prop) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same apkconfiguration object is created within this renderer
			if (gradients[key]) {
				id = gradients[key].id;
...
Axis.prototype = {
	...
	/** 
	 * The default label formatter. The context is a special apkconfiguration object for the label.
	 */
...
Chart.prototype = {
	 ...
	 *
	 * @param {Object} options The apkconfiguration options
	...
	/**
	 * Create the Axis instances based on the apkconfiguration options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original apkconfiguration options for
...
Series.prototype = {
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			// a specific marker apkconfiguration object is defined for the individual point:
			...
			// no marker apkconfiguration object is created: copy a reference to the series-wide
