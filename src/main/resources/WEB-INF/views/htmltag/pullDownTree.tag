...
@var placeholder = placeholder!'请选择分类';
<div class="btn-group ${class!}"   style="width:${width}";>
	<span data-toggle="dropdown" class="btn btn-primary btn-white dropdown-toggle width-100">
		<span id="pullDownTreeCurName${order}">${placeholder!}</span> <i class="ace-icon fa fa-angle-down icon-on-right"></i>
	</span>

	<div class="dropdown-menu dropdown-caret scrollable width-100" data-height="250" style="background: #002234;">
